    ...
    coe
      (let v1 = MAlonzo.Code.Level.d_0ℓ_22 in
       coe
         (let v2
                = coe
                    MAlonzo.Code.Algebra.Solver.Ring.AlmostCommutativeRing.du_fromCommutativeSemiring_1390
                    (coe
                       MAlonzo.Code.Data.Nat.Properties.d_'43''45''42''45'commutativeSemiring_2642) in
          coe
            (let v3 = MAlonzo.Code.Data.Nat.Properties.d__'8799'__1528 in
             coe
               (coe
...
d_0H_74 :: Integer -> MAlonzo.Code.Algebra.Solver.Ring.T_HNF_430
d_0H_74 ~v0 = du_0H_74
du_0H_74 :: MAlonzo.Code.Algebra.Solver.Ring.T_HNF_430
du_0H_74 = coe MAlonzo.Code.Algebra.Solver.Ring.C_'8709'_436
-- Data.Nat.Solver.+-*-Solver.0N
d_0N_76 :: Integer -> MAlonzo.Code.Algebra.Solver.Ring.T_Normal_432
d_0N_76
  = let v0
          = coe
              MAlonzo.Code.Algebra.Solver.Ring.AlmostCommutativeRing.du_fromCommutativeSemiring_1390
...
d_1H_82 :: Integer -> MAlonzo.Code.Algebra.Solver.Ring.T_HNF_430
d_1H_82
  = let v0 = MAlonzo.Code.Level.d_0ℓ_22 in
    coe
      (let v1 = MAlonzo.Code.Level.d_0ℓ_22 in
...
d_1N_84 :: Integer -> MAlonzo.Code.Algebra.Solver.Ring.T_Normal_432
d_1N_84
  = let v0 = MAlonzo.Code.Level.d_0ℓ_22 in
    coe
      (let v1 = MAlonzo.Code.Level.d_0ℓ_22 in
...
d_normalise'45'con_118 ::
  Integer -> Integer -> MAlonzo.Code.Algebra.Solver.Ring.T_Normal_432
d_normalise'45'con_118
  = let v0 = MAlonzo.Code.Level.d_0ℓ_22 in
    coe
      (let v1 = MAlonzo.Code.Level.d_0ℓ_22 in
...
d_sem_130
  = let v0
          = coe
              ...
              (coe
                 MAlonzo.Code.Data.Nat.Properties.d_'43''45''42''45'commutativeSemiring_2642) in
    coe (coe MAlonzo.Code.Algebra.Solver.Ring.du_sem_398 (coe v0))
