             ...
             (case coe v1 of
                ...
                _ -> let v3 = subInt (coe v1) (coe (1 :: Integer)) in
                     coe
                       (coe
                          addInt (coe (1 :: Integer))
                          (coe d__'8852'__106 (coe v2) (coe v3))))
-- Data.Nat.Base._⊓_
             ...
             (case coe v1 of
                ...
                _ -> let v3 = subInt (coe v1) (coe (1 :: Integer)) in
                     coe
                       (coe
                          addInt (coe (1 :: Integer))
                          (coe d__'8851'__116 (coe v2) (coe v3))))
-- Data.Nat.Base.⌊_/2⌋
  ...
  = case coe v0 of
      ...
      _ -> let v1 = subInt (coe v0) (coe (2 :: Integer)) in
           coe
             (coe
                addInt (coe (1 :: Integer))
                (coe d_'8970'_'47'2'8971'_126 (coe v1)))
-- Data.Nat.Base.⌈_/2⌉
...
d__'94'__134 v0 v1
  = case coe v1 of
      ...
      _ -> let v2 = subInt (coe v1) (coe (1 :: Integer)) in
           coe (coe mulInt (coe v0) (coe d__'94'__134 (coe v0) (coe v2)))
-- Data.Nat.Base.∣_-_∣
      ...
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (case coe v1 of
                0 -> coe v0
                _ -> let v3 = subInt (coe v1) (coe (1 :: Integer)) in
                     coe (coe d_'8739'_'45'_'8739'_142 (coe v2) (coe v3)))
-- Data.Nat.Base._≤′_
...
d_compare_274 v0 v1
  = case coe v0 of
      0 -> case coe v1 of
             0 -> coe C_equal_262
             _ -> let v2 = subInt (coe v1) (coe (1 :: Integer)) in
                  coe (coe C_less_258 v2)
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (case coe v1 of
                0 -> coe C_greater_268 v2
                _ -> let v3 = subInt (coe v1) (coe (1 :: Integer)) in
                     coe (coe d_compare_274 (coe v2) (coe v3)))
