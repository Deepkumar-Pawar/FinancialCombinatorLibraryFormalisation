...
du_recBuilder_24 v0 v1
  = case coe v1 of
      ...
      _ -> let v2 = subInt (coe v1) (coe (1 :: Integer)) in
           coe (coe v0 v2 (coe du_recBuilder_24 (coe v0) (coe v2)))
-- Data.Nat.Induction.rec
d_rec_38 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  (Integer -> ()) ->
...
d_wfRec_106 ::
  ...
  (Integer ->
   (Integer ->
    MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__154 -> AgdaAny) ->
   AgdaAny) ->
  Integer -> AgdaAny
...
du_wfRec_106 ::
  ...
  (Integer ->
   ...
   AgdaAny) ->
  Integer -> AgdaAny
du_wfRec_106 = coe MAlonzo.Code.Induction.WellFounded.du_wfRec_164
...
du_wfRecBuilder_108 v0 v1 v2
  = coe MAlonzo.Code.Induction.WellFounded.du_wfRecBuilder_156 v1
-- Data.Nat.Induction.<-Rec
d_'60''45'Rec_112 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  (Integer -> ()) -> Integer -> ()
...
du_wfRec_146 ::
  ...
  (Integer ->
   ...
   AgdaAny) ->
  Integer -> AgdaAny
du_wfRec_146 = coe MAlonzo.Code.Induction.WellFounded.du_wfRec_164
-- Data.Nat.Induction._._.wfRecBuilder
d_wfRecBuilder_148 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  (Integer -> ()) ->
...
du_wfRecBuilder_148 v0 v1 v2
  = coe MAlonzo.Code.Induction.WellFounded.du_wfRecBuilder_156 v1
-- Data.Nat.Induction.rec-builder
d_rec'45'builder_150 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  (Integer -> ()) ->
  (Integer -> AgdaAny -> AgdaAny) -> Integer -> AgdaAny
d_rec'45'builder_150 v0 v1 v2 v3 = coe du_recBuilder_24 v2 v3
-- Data.Nat.Induction.cRec-builder
d_cRec'45'builder_152 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  (Integer -> ()) ->
  (Integer -> AgdaAny -> AgdaAny) -> Integer -> AgdaAny
d_cRec'45'builder_152 v0 v1 v2 v3 = coe du_cRecBuilder_56 v0 v2 v3
-- Data.Nat.Induction.<′-rec-builder
d_'60''8242''45'rec'45'builder_154 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  (Integer -> ()) ->
  (Integer ->
   (Integer ->
  ...
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__154 -> AgdaAny
d_'60''8242''45'rec'45'builder_154 ~v0
  = du_'60''8242''45'rec'45'builder_154
du_'60''8242''45'rec'45'builder_154 ::
  (Integer -> ()) ->
  (Integer ->
   (Integer ->
  ...
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__154 -> AgdaAny
du_'60''8242''45'rec'45'builder_154 v0 v1 v2
  = coe MAlonzo.Code.Induction.WellFounded.du_wfRecBuilder_156 v1
-- Data.Nat.Induction.<-rec-builder
d_'60''45'rec'45'builder_156 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  (Integer -> ()) ->
  (Integer ->
   (Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__18 -> AgdaAny) ->
  ...
  Integer ->
  Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__18 -> AgdaAny
d_'60''45'rec'45'builder_156 ~v0 = du_'60''45'rec'45'builder_156
du_'60''45'rec'45'builder_156 ::
  (Integer -> ()) ->
  (Integer ->
   (Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__18 -> AgdaAny) ->
   AgdaAny) ->
  Integer ->
  Integer -> MAlonzo.Code.Data.Nat.Base.T__'8804'__18 -> AgdaAny
du_'60''45'rec'45'builder_156 v0 v1 v2
  = coe MAlonzo.Code.Induction.WellFounded.du_wfRecBuilder_156 v1
-- Data.Nat.Induction.<′-well-founded
d_'60''8242''45'well'45'founded_158 ::
  Integer -> MAlonzo.Code.Induction.WellFounded.T_Acc_42
d_'60''8242''45'well'45'founded_158 = erased
-- Data.Nat.Induction.<′-well-founded′
d_'60''8242''45'well'45'founded'8242'_160 ::
  Integer ->
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T__'8804''8242'__154 ->
  MAlonzo.Code.Induction.WellFounded.T_Acc_42
d_'60''8242''45'well'45'founded'8242'_160 = erased
-- Data.Nat.Induction.<-well-founded
d_'60''45'well'45'founded_162 ::
  Integer -> MAlonzo.Code.Induction.WellFounded.T_Acc_42
d_'60''45'well'45'founded_162 = erased
