...
d_curry'8319'_52 ::
  ...
  () ->
  Integer ->
  (MAlonzo.Code.Data.Vec.Base.T_Vec_24 -> AgdaAny) -> AgdaAny
...
du_curry'8319'_52 v0 v1
  = case coe v0 of
      0 -> coe v1 (coe MAlonzo.Code.Data.Vec.Base.C_'91''93'_28)
             ...
             (coe
                (\ v3 ->
                   coe
                     ...
                     (coe
                        (\ v4 ->
                           coe v1 (coe MAlonzo.Code.Data.Vec.Base.C__'8759'__36 v3 v4)))))
-- Data.Vec.N-ary._$ⁿ_
d__'36''8319'__64 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  () ->
...
du__'36''8319'__64 v0 v1
  = case coe v1 of
      MAlonzo.Code.Data.Vec.Base.C_'91''93'_28 -> coe v0
      MAlonzo.Code.Data.Vec.Base.C__'8759'__36 v3 v4
...
du_'8658'_214 v0 v1 v2
  = case coe v0 of
      ...
      _ -> let v3 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (case coe v2 of
                MAlonzo.Code.Data.Vec.Base.C__'8759'__36 v5 v6
...
du_'8658'_268 v0 v1
  = case coe v0 of
      0 -> coe
             ...
             (coe MAlonzo.Code.Data.Vec.Base.C_'91''93'_28) (coe v1)
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (case coe v1 of
                MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v3 v4
                  -> coe
                       ...
                       (coe MAlonzo.Code.Data.Vec.Base.C__'8759'__36 (coe v3))
      ...
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           coe
             (case coe v1 of
                MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v3 v4
                  -> case coe v3 of
                       MAlonzo.Code.Data.Vec.Base.C__'8759'__36 v6 v7
                         -> coe
