...
du_'91'_'44'_'93''8347'_88 v0 v1
  = coe
      ...
      (coe
         ...
         (coe
            MAlonzo.Code.Function.Equality.d__'10216''36''10217'__38 (coe v1)))
      (coe du_'46'extendedlambda0_98 (coe v0) (coe v1))
...
d_'46'extendedlambda0_98 ::
  ...
  MAlonzo.Code.Data.Sum.Relation.Binary.Pointwise.T_Pointwise_34 ->
  AgdaAny
d_'46'extendedlambda0_98 ~v0 ~v1 ~v2 ~v3 ~v4 ~v5 ~v6 ~v7 ~v8 v9 v10
                         v11 v12 v13
  = du_'46'extendedlambda0_98 v9 v10 v11 v12 v13
du_'46'extendedlambda0_98 ::
  ...
  MAlonzo.Code.Data.Sum.Relation.Binary.Pointwise.T_Pointwise_34 ->
  AgdaAny
du_'46'extendedlambda0_98 v0 v1 v2 v3 v4
  = case coe v4 of
      MAlonzo.Code.Data.Sum.Relation.Binary.Pointwise.C_inj'8321'_64 v7
        -> case coe v2 of
             MAlonzo.Code.Data.Sum.Base.C_inj'8321'_38 v8
