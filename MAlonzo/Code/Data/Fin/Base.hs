...
d_fromℕ_58 v0
  = case coe v0 of
      ...
      _ -> let v1 = subInt (coe v0) (coe (1 :: Integer)) in
           coe (coe C_suc_16 (d_fromℕ_58 (coe v1)))
-- Data.Fin.Base.fromℕ<
d_fromℕ'60'_66 ::
  Integer ->
...
du_fromℕ'60'_66 v0
  = case coe v0 of
      0 -> coe C_zero_10
      _ -> let v1 = subInt (coe v0) (coe (1 :: Integer)) in
           coe (coe C_suc_16 (coe du_fromℕ'60'_66 (coe v1)))
-- Data.Fin.Base.fromℕ<″
d_fromℕ'60''8243'_82 ::
  Integer ->
  Integer ->
...
du_raise_90 v0 v1
  = case coe v0 of
      0 -> coe v1
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           coe (coe C_suc_16 (coe du_raise_90 (coe v2) (coe v1)))
  ...
  = case coe v1 of
      ...
      C_suc_16 v3
        -> let v4 = subInt (coe v0) (coe (1 :: Integer)) in
           coe (coe d__ℕ'45'__392 (coe v4) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Data.Fin.Base._ℕ-ℕ_
...
d__ℕ'45'ℕ__402 v0 v1
  = case coe v1 of
      ...
      C_suc_16 v3
        -> let v4 = subInt (coe v0) (coe (1 :: Integer)) in
           coe (coe d__ℕ'45'ℕ__402 (coe v4) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Data.Fin.Base.pred
