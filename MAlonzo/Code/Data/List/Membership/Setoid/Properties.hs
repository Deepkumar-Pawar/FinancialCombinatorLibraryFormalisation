                                 ...
                                 (coe
                                    ...
                                    (coe
                                       ...
                                       (coe
                                          v1 v5
                                          (coe
                                             MAlonzo.Code.Data.List.Base.du_foldr_240 (coe v1)
                                             (coe v3) (coe v6)))
                                       (coe
                                          MAlonzo.Code.Data.List.Base.du_foldr_240 (coe v1) (coe v3)
                                          (coe v6))
...
du_'8712''45''8759''61''8315'_1838 v0 v1 v2
  = case coe v1 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Pointwise
d_Pointwise_31085 a0 a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11 a12 a13
  = ()
-- Pointwise
d_Pointwise_63683 a0 a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 = ()
