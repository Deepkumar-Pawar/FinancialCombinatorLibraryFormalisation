...
du__'215'__40 v0
  = coe
      ...
      (coe
         MAlonzo.Code.Algebra.Bundles.du_'43''45'rawMonoid_1340
         (coe
            MAlonzo.Code.Algebra.Bundles.du_rawNearSemiring_1768 (coe v0)))
-- Algebra.Definitions.RawSemiring._._×′_
d__'215''8242'__42 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
...
du__'215''8242'__42 v0
  = let v1
          = coe
              MAlonzo.Code.Algebra.Bundles.du_'43''45'rawMonoid_1340
              (coe
                 MAlonzo.Code.Algebra.Bundles.du_rawNearSemiring_1768 (coe v0)) in
    coe
      (coe
         (\ v2 v3 ->
            ...
            coe
              (let v5
                     = coe
                         MAlonzo.Code.Algebra.Bundles.d__'8729'__492 v1
                         (coe
               ...
               coe
                 (case coe v2 of
                    0 -> coe MAlonzo.Code.Algebra.Bundles.d_ε_494 (coe v1)
                    1 -> coe v3
                    _ -> coe v5))))
...
du_sum_68 v0
  = coe
      MAlonzo.Code.Algebra.Definitions.RawMonoid.du_sum_64
      (coe
         MAlonzo.Code.Algebra.Bundles.du_'42''45'rawMonoid_1780 (coe v0))
...
du__'94''8242'__76 v0 v1 v2
  = let v3
          = coe
              MAlonzo.Code.Algebra.Bundles.du_'42''45'rawMonoid_1780 (coe v0) in
    coe
      (let v4 = subInt (coe v2) (coe (1 :: Integer)) in
       coe
         (let v5
                = coe
                    MAlonzo.Code.Algebra.Bundles.d__'8729'__492 v3
                    (coe
                       MAlonzo.Code.Algebra.Definitions.RawMonoid.du__'215''8242'__52
          ...
          coe
            (case coe v2 of
               0 -> coe MAlonzo.Code.Algebra.Bundles.d_ε_494 (coe v3)
               1 -> coe v1
               _ -> coe v5)))
...
d_Irreducible_92 a0 a1 a2 a3 = ()
newtype T_Irreducible_92
  = C_mkIrred_112 (AgdaAny ->
...
d_p'8740'1_104 = erased
-- Algebra.Definitions.RawSemiring.Irreducible.split-∣1
d_split'45''8739'1_110 ::
  T_Irreducible_92 ->
  AgdaAny ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_split'45''8739'1_110 v0
  = case coe v0 of
      C_mkIrred_112 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Definitions.RawSemiring.Prime
d_Prime_116 a0 a1 a2 a3 = ()
newtype T_Prime_116
  = C_mkPrime_136 (AgdaAny ->
                   AgdaAny ->
                   MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
                   MAlonzo.Code.Data.Sum.Base.T__'8846'__30)
-- Algebra.Definitions.RawSemiring.Prime.p≉0
d_p'8777'0_128 ::
  T_Prime_116 -> AgdaAny -> MAlonzo.Code.Data.Empty.T_'8869'_4
d_p'8777'0_128 = erased
-- Algebra.Definitions.RawSemiring.Prime.split-∣
d_split'45''8739'_134 ::
  T_Prime_116 ->
  AgdaAny ->
  AgdaAny ->
  MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14 ->
  MAlonzo.Code.Data.Sum.Base.T__'8846'__30
d_split'45''8739'_134 v0
  = case coe v0 of
      C_mkPrime_136 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
