...
data T_IsAlmostCommutativeRing_26
  = C_IsAlmostCommutativeRing'46'constructor_1027 MAlonzo.Code.Algebra.Structures.T_IsCommutativeSemiring_1344
...
data T_AlmostCommutativeRing_176
  = C_AlmostCommutativeRing'46'constructor_5955 (AgdaAny ->
                                                 AgdaAny -> AgdaAny)
                                                (AgdaAny -> AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
...
d__'43'__202 v0
  = case coe v0 of
      C_AlmostCommutativeRing'46'constructor_5955 v3 v4 v5 v6 v7 v8
        -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._*_
d__'42'__204 ::
         ...
         (let v3
          ...
          coe
            (coe
               ...
               (coe
                  MAlonzo.Code.Algebra.Bundles.du_'42''45'monoid_1916 (coe v3)))))
-- Algebra.Solver.Ring.AlmostCommutativeRing.AlmostCommutativeRing._.+-commutativeMonoid
         ...
         (let v3
          ...
          coe
            (let v4
             ...
             coe
               (let v5
                      = coe MAlonzo.Code.Algebra.Bundles.du_monoid_650 (coe v4) in
                coe
                  (coe
                     MAlonzo.Code.Algebra.Bundles.du_magma_254
...
du_rawRing_340 v0
  = coe
      MAlonzo.Code.Algebra.Bundles.C_RawRing'46'constructor_42493
      (d__'43'__202 (coe v0)) (d__'42'__204 (coe v0))
...
data T__'45'Raw'45'AlmostCommutative'10230'__354
  = C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_9425 (AgdaAny ->
                                                                 AgdaAny)
                                                                (AgdaAny -> AgdaAny -> AgdaAny)
                                                                (AgdaAny -> AgdaAny -> AgdaAny)
                                                                (AgdaAny -> AgdaAny) AgdaAny AgdaAny
...
d_'10214'_'10215'_744 v0
  = case coe v0 of
      C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_9425 v1 v2 v3 v4 v5 v6
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_'45'raw'45'almostCommutative'10230'_762 v0
  = coe
      C__'45'Raw'45'AlmostCommutative'10230'_'46'constructor_9425
      (coe (\ v1 -> v1))
      (coe
         (\ v1 v2 ->
            coe
              ...
              (let v3 = coe du_rawRing_340 (coe v0) in
               coe (coe MAlonzo.Code.Algebra.Bundles.d__'43'__2484 v3 v1 v2))))
      (coe
         (\ v1 v2 ->
            coe
              MAlonzo.Code.Relation.Binary.Structures.d_refl_34
                             ...
                             (coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe d_isAlmostCommutativeRing_212 (coe v0))))))))))
              (let v3 = coe du_rawRing_340 (coe v0) in
               coe (coe MAlonzo.Code.Algebra.Bundles.d__'42'__2486 v3 v1 v2))))
      (coe
         (\ v1 ->
            coe
              MAlonzo.Code.Relation.Binary.Structures.d_refl_34
              ...
              (let v2 = coe du_rawRing_340 (coe v0) in
               coe (coe MAlonzo.Code.Algebra.Bundles.d_'45'__2488 v2 v1))))
      (coe
         MAlonzo.Code.Relation.Binary.Structures.d_refl_34
         (MAlonzo.Code.Algebra.Structures.d_isEquivalence_94
            (coe
         ...
         (let v1 = coe du_rawRing_340 (coe v0) in
          coe (MAlonzo.Code.Algebra.Bundles.d_0'35'_2490 (coe v1))))
      (coe
         MAlonzo.Code.Relation.Binary.Structures.d_refl_34
         (MAlonzo.Code.Algebra.Structures.d_isEquivalence_94
            (coe
                        ...
                        (coe
                           ...
                           (coe
                              ...
                              (coe
                                 ...
                                 (coe d_isAlmostCommutativeRing_212 (coe v0))))))))))
         (let v1 = coe du_rawRing_340 (coe v0) in
          coe (MAlonzo.Code.Algebra.Bundles.d_1'35'_2492 (coe v1))))
...
du_fromCommutativeRing_1108 v0
  = coe
      C_AlmostCommutativeRing'46'constructor_5955
