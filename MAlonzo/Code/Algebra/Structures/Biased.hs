...
d_isSemigroup_1526 v0
  = case coe v0 of
      C_IsCommutativeMonoid'737''46'constructor_18101 v1 v2 v3 -> coe v1
...
d_identity'737'_1528 v0
  = case coe v0 of
      C_IsCommutativeMonoid'737''46'constructor_18101 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_comm_1530 v0
  = case coe v0 of
      C_IsCommutativeMonoid'737''46'constructor_18101 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isSemigroup_1580 v0
  = case coe v0 of
      C_IsCommutativeMonoid'691''46'constructor_19839 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_identity'691'_1582 v0
  = case coe v0 of
      C_IsCommutativeMonoid'691''46'constructor_19839 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_comm_1584 v0
  = case coe v0 of
      C_IsCommutativeMonoid'691''46'constructor_19839 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_'43''45'isCommutativeMonoid_1644 v0
  = case coe v0 of
      C_IsCommutativeSemiring'737''46'constructor_21625 v1 v2 v3 v4
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Structures.Biased.IsCommutativeSemiringˡ.*-isCommutativeMonoid
...
d_'43''45'isCommutativeMonoid_1772 v0
  = case coe v0 of
      C_IsCommutativeSemiring'691''46'constructor_26987 v1 v2 v3 v4
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Algebra.Structures.Biased.IsCommutativeSemiringʳ.*-isCommutativeMonoid
...
d_'43''45'isAbelianGroup_1902 v0
  = case coe v0 of
      C_IsRingWithoutAnnihilatingZero'46'constructor_32383 v1 v2 v3
        -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
      ...
      (let v5 = d_'43''45'isAbelianGroup_1902 (coe v4) in
       coe
         (let v6 = MAlonzo.Code.Algebra.Structures.d_isGroup_674 (coe v5) in
          coe
            (let v7
                   = MAlonzo.Code.Algebra.Structures.d_isMonoid_594 (coe v6) in
             coe
               (let v8
