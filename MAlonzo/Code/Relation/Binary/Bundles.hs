...
newtype T_DecSetoid_84
  = C_DecSetoid'46'constructor_1385 MAlonzo.Code.Relation.Binary.Structures.T_IsDecEquivalence_44
...
d_isDecEquivalence_100 v0
  = case coe v0 of
      C_DecSetoid'46'constructor_1385 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
newtype T_Preorder_132
  = C_Preorder'46'constructor_2269 MAlonzo.Code.Relation.Binary.Structures.T_IsPreorder_70
...
d_isPreorder_154 v0
  = case coe v0 of
      C_Preorder'46'constructor_2269 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
newtype T_TotalPreorder_204
  = C_TotalPreorder'46'constructor_3669 MAlonzo.Code.Relation.Binary.Structures.T_IsTotalPreorder_118
...
d_isTotalPreorder_226 v0
  = case coe v0 of
      C_TotalPreorder'46'constructor_3669 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_preorder_248 v0
  = coe
      C_Preorder'46'constructor_2269
      (MAlonzo.Code.Relation.Binary.Structures.d_isPreorder_126
         (coe d_isTotalPreorder_226 (coe v0)))
...
d_Carrier_258 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 -> T_TotalPreorder_204 -> ()
...
du_partialSetoid_264 v0
  = let v1 = coe du_preorder_248 (coe v0) in
    coe (coe du_partialSetoid_74 (coe du_setoid_174 (coe v1)))
...
newtype T_Poset_282
  = C_Poset'46'constructor_5219 MAlonzo.Code.Relation.Binary.Structures.T_IsPartialOrder_162
...
d_isPartialOrder_304 v0
  = case coe v0 of
      C_Poset'46'constructor_5219 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_Carrier_336 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 -> T_Poset_282 -> ()
...
newtype T_DecPoset_360
  = C_DecPoset'46'constructor_6777 MAlonzo.Code.Relation.Binary.Structures.T_IsDecPartialOrder_206
...
d_isDecPartialOrder_382 v0
  = case coe v0 of
      C_DecPoset'46'constructor_6777 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_decSetoid_436 v0
  = coe
      C_DecSetoid'46'constructor_1385
      (coe
...
d_Carrier_446 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 -> T_DecPoset_360 -> ()
...
du_partialSetoid_454 v0
  = let v1 = coe du_decSetoid_436 (coe v0) in
    coe (coe du_partialSetoid_74 (coe du_setoid_118 (coe v1)))
...
newtype T_StrictPartialOrder_472
  = C_StrictPartialOrder'46'constructor_8957 MAlonzo.Code.Relation.Binary.Structures.T_IsStrictPartialOrder_266
...
d_isStrictPartialOrder_494 v0
  = case coe v0 of
      C_StrictPartialOrder'46'constructor_8957 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
newtype T_DecStrictPartialOrder_546
  = C_DecStrictPartialOrder'46'constructor_10419 MAlonzo.Code.Relation.Binary.Structures.T_IsDecStrictPartialOrder_314
...
d_isDecStrictPartialOrder_568 v0
  = case coe v0 of
      C_DecStrictPartialOrder'46'constructor_10419 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_strictPartialOrder_612 v0
  = coe
      C_StrictPartialOrder'46'constructor_8957
      (MAlonzo.Code.Relation.Binary.Structures.d_isStrictPartialOrder_324
         (coe d_isDecStrictPartialOrder_568 (coe v0)))
...
newtype T_TotalOrder_652
  = C_TotalOrder'46'constructor_12489 MAlonzo.Code.Relation.Binary.Structures.T_IsTotalOrder_384
...
d_isTotalOrder_674 v0
  = case coe v0 of
      C_TotalOrder'46'constructor_12489 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_Carrier_714 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 -> T_TotalOrder_652 -> ()
...
du_partialSetoid_720 v0
  = let v1 = coe du_poset_702 (coe v0) in
    coe
      (let v2 = coe du_preorder_326 (coe v1) in
       coe (coe du_partialSetoid_74 (coe du_setoid_174 (coe v2))))
...
du_setoid_726 v0
  = let v1 = coe du_poset_702 (coe v0) in
    coe (coe du_setoid_174 (coe du_preorder_326 (coe v1)))
...
du_totalPreorder_732 v0
  = coe
      C_TotalPreorder'46'constructor_3669
      (coe
         MAlonzo.Code.Relation.Binary.Structures.du_isTotalPreorder_428
         (coe d_isTotalOrder_674 (coe v0)))
...
newtype T_DecTotalOrder_740
  = C_DecTotalOrder'46'constructor_14337 MAlonzo.Code.Relation.Binary.Structures.T_IsDecTotalOrder_434
...
d_isDecTotalOrder_762 v0
  = case coe v0 of
      C_DecTotalOrder'46'constructor_14337 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_totalOrder_816 v0
  = coe
      C_TotalOrder'46'constructor_12489
      (MAlonzo.Code.Relation.Binary.Structures.d_isTotalOrder_444
         (coe d_isDecTotalOrder_762 (coe v0)))
...
du_preorder_822 v0
  = let v1 = coe du_totalOrder_816 (coe v0) in
    coe (coe du_preorder_326 (coe du_poset_702 (coe v1)))
...
du_decPoset_824 v0
  = coe
      C_DecPoset'46'constructor_6777
      (coe
         MAlonzo.Code.Relation.Binary.Structures.du_isDecPartialOrder_476
         (coe d_isDecTotalOrder_762 (coe v0)))
...
d_Carrier_836 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 -> T_DecTotalOrder_740 -> ()
...
du_partialSetoid_846 v0
  = let v1 = coe du_decPoset_824 (coe v0) in
    coe
      (let v2 = coe du_decSetoid_436 (coe v1) in
       coe (coe du_partialSetoid_74 (coe du_setoid_118 (coe v2))))
...
du_setoid_852 v0
  = let v1 = coe du_decPoset_824 (coe v0) in
    coe (coe du_setoid_118 (coe du_decSetoid_436 (coe v1)))
...
newtype T_StrictTotalOrder_864
  = C_StrictTotalOrder'46'constructor_16739 MAlonzo.Code.Relation.Binary.Structures.T_IsStrictTotalOrder_502
...
d_isStrictTotalOrder_886 v0
  = case coe v0 of
      C_StrictTotalOrder'46'constructor_16739 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_partialSetoid_932 v0
  = let v1 = coe du_strictPartialOrder_916 (coe v0) in
    coe (coe du_partialSetoid_74 (coe du_setoid_516 (coe v1)))
