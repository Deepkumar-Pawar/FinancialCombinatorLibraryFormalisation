...
data T_RawIMonad_32
  = C_RawIMonad'46'constructor_711 (() ->
...
d_return_52 v0
  = case coe v0 of
      C_RawIMonad'46'constructor_711 v1 v2 -> coe v1
...
d__'62''62''61'__60 v0
  = case coe v0 of
      C_RawIMonad'46'constructor_711 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Category.Monad.Indexed.RawIMonad._>>_
d__'62''62'__68 ::
...
data T_RawIMonadZero_174
  = C_RawIMonadZero'46'constructor_10609 T_RawIMonad_32
...
d_monad_184 v0
  = case coe v0 of
      C_RawIMonadZero'46'constructor_10609 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_applicativeZero_186 v0
  = case coe v0 of
      C_RawIMonadZero'46'constructor_10609 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_pure_216 ::
  T_RawIMonadZero_174 -> () -> AgdaAny -> AgdaAny -> AgdaAny
du_pure_216 v0
  = let v1 = d_monad_184 (coe v0) in coe (coe d_return_52 (coe v1))
...
data T_RawIMonadPlus_240
  = C_RawIMonadPlus'46'constructor_12775 T_RawIMonad_32
...
d_monad_250 v0
  = case coe v0 of
      C_RawIMonadPlus'46'constructor_12775 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_alternative_252 v0
  = case coe v0 of
      C_RawIMonadPlus'46'constructor_12775 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_pure_282 ::
  T_RawIMonadPlus_240 -> () -> AgdaAny -> AgdaAny -> AgdaAny
du_pure_282 v0
  = let v1 = d_monad_250 (coe v0) in coe (coe d_return_52 (coe v1))
...
du_monadZero_300 v0
  = coe
      C_RawIMonadZero'46'constructor_10609 (coe d_monad_250 (coe v0))
      (coe
         MAlonzo.Code.Category.Applicative.Indexed.d_applicativeZero_224
         (coe d_alternative_252 (coe v0)))
