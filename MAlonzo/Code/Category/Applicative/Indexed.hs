...
d_pure_58 v0
  = case coe v0 of
      C_RawIApplicative'46'constructor_815 v1 v2 -> coe v1
...
d__'8859'__66 v0
  = case coe v0 of
      C_RawIApplicative'46'constructor_815 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_applicative_170 v0
  = case coe v0 of
      C_RawIApplicativeZero'46'constructor_10911 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Category.Applicative.Indexed.RawIApplicativeZero.∅
d_'8709'_176 ::
...
d_'8709'_176 v0
  = case coe v0 of
      C_RawIApplicativeZero'46'constructor_10911 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_applicativeZero_224 v0
  = case coe v0 of
      C_RawIAlternative'46'constructor_12491 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d__'8739'__230 v0
  = case coe v0 of
      C_RawIAlternative'46'constructor_12491 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
du__'8855'__242 v0
  = let v1 = d_applicativeZero_224 (coe v0) in
    coe
      (\ v2 v3 v4 v5 v6 v7 v8 ->
         coe
           du__'8855'__120 (coe d_applicative_170 (coe v1)) v4 v5 v6 v7 v8)
-- Category.Applicative.Indexed.RawIAlternative._._⊛_
d__'8859'__244 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
...
du__'8859'__244 v0
  = let v1 = d_applicativeZero_224 (coe v0) in
    coe (coe d__'8859'__66 (coe d_applicative_170 (coe v1)))
-- Category.Applicative.Indexed.RawIAlternative._._⊛>_
d__'8859''62'__246 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
...
du__'8859''62'__246 v0
  = let v1 = d_applicativeZero_224 (coe v0) in
    coe
      (\ v2 v3 v4 v5 v6 v7 v8 ->
         coe
           du__'8859''62'__108 (coe d_applicative_170 (coe v1)) v4 v5 v6 v7
           v8)
...
du_rawFunctor_252 v0
  = let v1 = d_applicativeZero_224 (coe v0) in
    coe (coe du_rawFunctor_72 (coe d_applicative_170 (coe v1)))
...
d_op_410 v0
  = case coe v0 of
      C_Morphism'46'constructor_18561 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
